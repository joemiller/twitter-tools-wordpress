...
Description: Set #hashtags for blog post tweets sent by Twitter Tools. 
Version: 1.0 
...
<div class="wrap">
	...
	<form id="aktt_hash_settings_form" name="aktt_hash_settings_form" action="'.get_bloginfo('wpurl').'/wp-admin/options-general.php" method="post">
